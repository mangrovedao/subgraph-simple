...
describe("Describe entity assertions", () => {
  ...
  test("Offer, handleOfferSuccessWithPosthookData", () => {
    ...
    let offerSuccess = createOfferSuccessWithPosthookDataEvent(olKeyHash01, id, taker, BigInt.fromI32(20), BigInt.fromI32(40), Bytes.fromUTF8("Posthook failed"));
  ...
  test('Order, handleOrderStart, is clean order', () => {
    const cleanStart = createCleanStartEvent(
      olKeyHash01,
      taker,
      BigInt.fromI32(1),
    )
  ...
  test('Order, handleCleanStart', () => {
    const cleanOrderStart =createCleanStartEvent(
      olKeyHash01,
      taker,
      BigInt.fromI32(1),
    )
  ...
  test('Order, handleCleanComplete', () => {
    ...
    handleCleanStart(cleanOrderStart);
    const orderStartEvent = createOrderStartEvent(
      olKeyHash01, 
      taker,
      BigInt.fromI32(40),
      BigInt.fromI32(1),
